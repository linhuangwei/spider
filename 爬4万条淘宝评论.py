...
for url in urls:
    ...
    for i in range(20):
        ...
        if (comment['appendComment']):
            ...
            appendpics.append(comment['appendComment']['pics'])
            appendreply.append(comment['appendComment']['reply'])

            # print('appendComment:', appendComment)
            # print('appendreply:', appendreply)
        else:
            appendComment.append(None)
            commentTime.append(None)
            content.append(None)
            appendpics.append(None)
            appendreply.append(None)
            # print('appendComment:', appendComment)
            # print('appendreply:', appendreply)

        auctionSku.append(comment['auctionSku'])
        displayUserNick.append(comment['displayUserNick'])
        pics.append(comment['pics'])
        rateContent.append(comment['rateContent'])
